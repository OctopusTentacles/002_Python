...
# которая выведет информацию о том, сколько килограммов гречки у
# вас должно быть в запасе через месяц, два и так далее,
# пока она не закончится. Используйте цикл for.

month = 0
for kilo in range(96, -1, -4):
    month += 1
    print("Через", month, "месяц(а/ев) останется", kilo, "килограммов гречки")
