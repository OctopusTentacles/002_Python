...
# функция map применяет функцию int к каждому элементу объекта 
# client_data[client][pizza] - лист с количеством заказов

# долго не мог понять как в листе с количеством заказов перевести цифры в int 
# чтобы посчитать сумму, во всех вариантах вылазила ошибка...
# полез в гугл - нашел функцию map, применил - вроде заработало.
# не знаю насколько это все корректно, но работает )))
