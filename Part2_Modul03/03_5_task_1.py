...
# Вашему другу, который тоже начал изучать Python, преподаватель 
# дал такую задачу: есть три списка — основной и два побочных. 
...
# После этого в основной закидывается второй побочный список, 
# там считается количество цифр 3 и выводится на экран. 
...
main_list = [1, 5, 3]
side1_list = [1, 5, 1, 5]
side2_list = [1, 3, 1, 5, 3, 3]

main_list.extend(side1_list)
five_count = main_list.count(5)
print('\nКол-во цифр 5 при первом объединении:', five_count)

for _ in range(five_count):
    main_list.remove(5)

main_list.extend(side2_list)
print('\nКол-во цифр 3 при втором объединении:', main_list.count(3))
