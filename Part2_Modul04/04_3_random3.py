...
# Есть два отряда, в каждом по 10 монстров. В первом отряде у каждого монстра 
# урон абсолютно случайный и колеблется от 50 до 80, а во втором — от 30 до 60. 
...
# в заданных диапазонах, а также генерирует список, состоящий из фраз «Погиб» 
# или «Выжил». Выведите все списки на экран.
...
team_3 = [('Погиб' if team_1[i] + team_2[i] > 100 
           else 'Выжил') 
           for i in range(10)]
