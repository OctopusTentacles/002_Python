...
# но интересную формулу, по которой высчитывается сколько он подарит:
...
age = int(input('Какой возрвст? '))
temp = float(input('Температура тела: '))

money = round(age * 1.5 * temp, 2)
print('Подарок будет', money, 'рублей')
