...
# Уфффф
# сам не понял как сделал, видать помог разбор алгоритма в ТЗ
# почитал, википедию почитал и почти с первого раза написал
# сам удивился что сработало

# можно (или нужно) тут что-то улучшить?