...
# В gen_markup мы создаём наши кнопки и задаём им callback, который будет 
# отправлен при нажатии. Нажатие обрабатывается с помощью обработчика 
# callback_query_handler (строка 16).

# ReplyKeyboardMarkup — кнопка с заготовленным текстом. 
# При нажатии на неё в чат будет отправлен текст, указанный на кнопке. 

# =======================================================================================
# Архитектура бота
# Когда проект разрастается, важно правильно выстроить архитектуру. 
