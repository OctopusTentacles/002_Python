...
# Ответ:
# Задание №7 Да, умножение матриц, которое вы реализовали, является стандартным 
# алгоритмом умножения матриц. В математике умножение двух матриц возможно 
# только тогда, когда количество столбцов первой матрицы равно количеству 
# строк второй матрицы. Это фундаментальное правило умножения матриц.
# В вашей реализации вы верно учли, что размерность итоговой матрицы определяется 
# автоматически на основе размерностей умножаемых матриц, а не задается заранее. 
# Если итоговый размер нам не известен, то мы не можем выполнить умножение, 
# так как матрицы не совместимы для этой операции.