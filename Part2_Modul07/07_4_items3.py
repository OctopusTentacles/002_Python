...
# это числа от 0 до 4, а значения ключей — числа 0, 100, 144, 20 и 19 
# соответственно. Нужно написать программу, которая выводит список 
# тех значений, у которых ключ делится на 2. 
# Причём программа должна быть в одну строчку.» 
# Программа у друга работает, но её не приняли, так как в ней не 
# используется правило «не повторяйся» — это когда части кода не повторяются. 
