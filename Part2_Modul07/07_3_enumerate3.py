...
# Один заказчик попросил нас написать небольшой скрипт для своих 
# криптографических нужд. При этом он заранее предупредил, что скрипт 
# должен уметь работать с любым итерируемым типом данных.
...
# если элемент принадлежит к этому типу данных, и возвращает False 
# в противном случае.
...
print(return_even_elements({0: 'е', 1: 'о', 2: 'ч', 3: 'ы', 4: 'в', 5: 'н', 
                            6: 'д', 7: 'а', 8: 'ш', 9: 'ц'}))
