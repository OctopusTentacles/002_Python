...
# Контекст 
# Вы работаете в компании, которая разрабатывает программное обеспечение для финансовых 
# анализов. Одна из ключевых задач в вашей работе — реализация сложного алгоритма для 
# прогнозирования финансовых показателей. Этот алгоритм требует множества вычислений 
# и может занимать длительное время. 

# Вам поставлена задача создать декоратор, который будет логировать аргументы, 
# результаты и время выполнения этой функции. Это поможет отслеживать прогресс 
# выполнения алгоритма и анализировать его производительность.
